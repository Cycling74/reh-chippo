...
public:
    ...
    void loadRNBOAudioProcessor()
    {
        ...
        if (_audioProcessorEditor)
        {
            ...
            auto bounds = _audioProcessorEditor->getLocalBounds();
    ...
    ~MainContentComponent() { shutdownAudio(); }
    ...
    void resized() override
    {
        ...
        if (_audioProcessorEditor)
        {
            _audioProcessorEditor->setBounds (_audioProcessorEditor->getLocalBounds());
        }
        //        _midiKeyboardComponent.setBounds (usedSelectorWidth,
        //                                          getHeight() - keysHeight,
        //                                          getWidth() - usedSelectorWidth,
        //                                          keysHeight);
    }
